 ...
 *
 * Be sure to replace all instances of 'vc_' with your project's prefix.
 ...
 */
function vc_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function vc_hide_if_no_cats( $field ) {
 ...
 */
function vc_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function vc_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field object $field      Field object.
 */
function vc_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'vc_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function vc_register_demo_metabox() {
	$prefix = 'vc_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		'object_types'  => array( 'bgcm_program' ), // Post type
		// 'show_on_cb' => 'vc_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'vc_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'vc_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'vc_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'vc_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'vc_before_row_if_2', // callback.
...
//add_action( 'cmb2_admin_init', 'vc_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function vc_register_about_page_metabox() {
	$prefix = 'vc_about_';
...
//add_action( 'cmb2_admin_init', 'vc_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function vc_register_repeatable_group_field_metabox() {
	$prefix = 'vc_group_';
...
//add_action( 'cmb2_admin_init', 'vc_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function vc_register_user_profile_metabox() {
	$prefix = 'vc_user_';
...
//add_action( 'cmb2_admin_init', 'vc_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function vc_register_taxonomy_metabox() {
	$prefix = 'vc_term_';
...
//add_action( 'cmb2_admin_init', 'vc_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function vc_register_theme_options_metabox() {

	$option_key = 'vc_theme_options';
 ...
 */
function vc_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'vc_register_rest_api_box' );
/**
 ...
 */
function vc_register_rest_api_box() {
	$prefix = 'vc_rest_';
	...
	$cmb_rest = new_cmb2_box( array(
		...
		// 'get_box_permissions_check_cb' => 'vc_limit_rest_view_to_logged_in_users',
	) );
